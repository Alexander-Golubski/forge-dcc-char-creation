...
const spOne = wizSpDraw.results[0].text;
const spTwo = wizSpDraw.results[1].text;
const spThree = wizSpDraw.results[2].text;
const spFour = wizSpDraw.results[3].text;
